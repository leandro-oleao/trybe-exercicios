...
function changeTech(evento) {
  let classTechChange = document.querySelector('.tech');
  classTechChange.classList.remove('tech');
...
myWebpage.addEventListener('dblclick',function() {
  window.open("https://leandro-oleao.github.io./");
}
)
